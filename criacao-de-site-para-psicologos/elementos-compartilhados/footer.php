<footer class="bg-light text-center py-4 mt-5 border-top" itemscope itemtype="https://schema.org/WPFooter">
    <div class="container">
        ...
        <p class="mb-0 text-muted fs-7">
            ...
            <a href="https://psicologosespecialistas.com.br" class="text-decoration-none fw-bold text-secondary" target="_blank" title="Política de Privacidade - Psicólogos Especialistas">
